...
keymap("n", "<leader>fgg", ":lua require('telescope').extensions.live_grep_args.live_grep_args()<CR>")
keymap("n", "<leader>fG", ":Telescope git_files<CR>")
keymap("n", "<leader>fj", ":Telescope jumplist<CR>")
keymap("n", "<leader>fn", ":lua require('telescope').extensions.notify.notify()<CR>")
