...
Homebrew is a package manager for MacOs. Its main focus is to handle apps to be used in the terminal.
 A subproject, Homebrew Cask, which builds upon Homebrew and focuses on the installation of GUI applications.
...
When installing a formulae or cask, the latest version in the homebrew tap will be used. The same is true when
 upgrading, unless you have pinned the formula to a specific version. Casks behaves a little bit different since
they usually have the ability to auto-update itself or by the user.
